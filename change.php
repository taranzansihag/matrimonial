...
<?php
$email=$_COOKIE["user"];  // retrieve cookie ( email id)
...
?>
                        ...
                        <div class="col-sm-3">
                            <div class="row">
                                <div class="col-sm-12 w3-card-12" style="height:130px;">
                                    <div class="row">
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-body">
										...
										?>
										  ...
										  <label class="w3-text-pink"> <form method="post" action="changepass.php">
